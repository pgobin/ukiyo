...
class DataSource {
    ...
    repoRoot(repoPath) {
        return this.spawnGit(['rev-parse', '--show-toplevel'], repoPath, (stdout) => utils_1.getPathFromUri(vscode_1.Uri.file(path.normalize(stdout.trim())))).then((root) => root, () => null);
    }
