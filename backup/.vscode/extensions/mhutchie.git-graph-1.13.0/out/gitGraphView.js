            ...
            switch (msg.command) {
                ...
                case 'commitDetails':
                    this.sendMessage({
                        ...
                        commitDetails: yield (msg.commitHash !== utils_1.UNCOMMITTED ? this.dataSource.getCommitDetails(msg.repo, msg.commitHash) : this.dataSource.getUncommittedDetails(msg.repo)),
                        refresh: msg.refresh
                    });
                    break;
                case 'compareCommits':
                    this.sendMessage(Object.assign({ command: 'compareCommits', commitHash: msg.commitHash, compareWithHash: msg.compareWithHash }, yield this.dataSource.getCommitComparison(msg.repo, msg.fromHash, msg.toHash), { refresh: msg.refresh }));
                    break;
                case 'copyFilePath':
                    this.sendMessage({
